...
export default function Feedback() {
  ...
  useEffect(() => {
    const fetchFeedbacks = async () => {
      try {
        const response = await axios.get('http://52.66.210.195:3000/admin/feedbacks', {
  ...
  const processRowUpdate = async (newRow) => {
    ...
    try {
      const response = await axios.put(`http://52.66.210.195:3000/admin/resolve-feedback/${newRow.id}`, {
